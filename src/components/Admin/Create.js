...
const Create = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://localhost:8081/item', values)
            .then(res => {
    ...
    return (
        <div>
            <div>
                <Form className='form-group' onSubmit={handleSubmit} action="#" method="post">
                    <Row className="mb-3">
                    ...
                    <Form.Group className="mb-3" controlId="formGridAddress2">
                        ...
                        <Form.Control onChange={e => setValues({ ...values, image: e.target.value })}></Form.Control>
                    </Form.Group>
